		...
		<table>
			<tbody>
				<tr>
					...
					<td class="active"><span> <fmt:formatNumber value="${goods.goods_price}" type="number" var="goods_price" /> ${goods_price}원
					</span></td>
				</tr>
				<tr class="dot_line">
					<td class="fixed">판매가</td>
					<td class="active"><span> <fmt:formatNumber value="${goods.goods_price*0.9}" type="number" var="discounted_price" />
				...
				<tr>
					...
					<td class="fixed"><strong>[당일배송]</strong> 당일배송 서비스 시작!<br> <strong>[휴일배송]</strong> 휴일에도 배송받는 이젠볼링~!</TD>
				</tr>
				<tr>
	...
	<div id="container">
		...
		<div class="tab_container">
			...
			<div class="tab_content" id="tab2">
				...
				<p>${fn:replace(goods.goods_manufacturer_intro,crcn,br) }</p>
